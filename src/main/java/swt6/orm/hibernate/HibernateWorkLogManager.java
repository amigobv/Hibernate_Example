...
public class HibernateWorkLogManager {
	...
	private static void saveModule(Module module, Project project) {
		Session session = HibernateUtil.getCurrentSession();
		Transaction tx = null;
	...
	private static void listEmployees() {
		...
		List<Employee> emplList = session.createQuery("select e from Employee e").list(); // uses
																							// NQL
																							// dialect
		// select e returns all columns from entity
		// Employee is the name of the java class
	...
	public static void main(String[] args) {
		try {
			...
			PermanentEmployee pe = new PermanentEmployee("Franz", "Mayr", DateUtil.getDate(1980, 12, 24));
			Employee empl1 = pe;
			...
			TemporaryEmployee te = new TemporaryEmployee("Bill", "Gates", DateUtil.getDate(1970, 1, 21));
			Employee empl2 = te;
			...
			LogbookEntry entry3 = new LogbookEntry("Testen", DateUtil.getTime(12, 30), DateUtil.getTime(17, 00), mantainance, mod1);
